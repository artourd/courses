...
class uploadPhoto {
     ...
     */
    function uploadPhoto($file, $lang = 'en_GB') {
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = strtr($this->file_dst_name_body, 'Е ЕЅЕЎЕѕЕёГЂГЃГ‚ГѓГ„Г…Г‡Г€Г‰ГЉГ‹ГЊГЌГЋГЏГ‘Г’Г“Г”Г•Г–Г?Г™ГљГ›ГњГќГ ГЎГўГЈГ¤ГҐГ§ГЁГ©ГЄГ«Г¬Г­Г®ГЇГ±ГІГіГґГµГ¶ГёГ№ГєГ»ГјГЅГї', 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy');
